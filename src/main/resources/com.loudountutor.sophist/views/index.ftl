...
<head>
    <meta charset="utf-8">
    <title>Create new account | Loudoun Tutor</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 additional-shop-info">
                <ul class="list-unstyled list-inline">
                    ...
                    <li><i class="fa fa-envelope-o"></i><span>info@sophist.com</span></li>
                </ul>
            </div>
                ...
                <div class="content-form-page">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 pull-right">
                            <div class="form-info">
                                <h2><em>About</em> Loudoun Tutor</h2>
                        ...
                        <div class="col-md-7 col-sm-7">
                            ...
                            <form class="form-horizontal" role="form">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="email" class="col-lg-4 control-label">Birth Date <span class="require">*</span></label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="tel" class="form-control" id="birthdate">
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
